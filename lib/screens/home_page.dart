...
import 'package:blup_assignment/utils/draw_points.dart';
import 'package:blup_assignment/state_management/home_page_controller.dart';
import 'package:blup_assignment/utils/paint_image.dart';
import 'package:blup_assignment/screens/saved_images.dart';
...
//create file
      ...
      print(result);
      homePageController.database.saveImagePath(capturedFile.path);
        ...
        child: Column(
          children: [
            Container(
              color: Colors.blue,
              width: width * 0.75,
              height: AppBar().preferredSize.height + height * 0.03,
            ),
            ListTile(
              title: const Text("Saved Images"),
              onTap: (){
                Navigator.of(context).pop();
                Navigator.of(context).push(MaterialPageRoute(builder: (context) => SavedImages()));
              },
            )
          ],
        ),
                                ...
                                children: [
                                  ...
                                  Obx(
                                    () => Container(
                                      ...
                                      width: height * 0.02,
                                      color: Color(
                                          homePageController.markerColor.value),
                                    ),
                                  )
                                ],
                              ),
                      ...
                      onPanStart: (dragDetails) {
                        homePageController.pointsList.add(DrawPoints(
                          paint: Paint()
                            ...
                            ..isAntiAlias = true
                            ..color =
                                Color(homePageController.markerColor.value)
